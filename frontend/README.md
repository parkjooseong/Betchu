...
- `/quests`, `/quests/new`, `/quests/[questId]`에서 본인 개인 퀘스트 초안을 생성·조회·수정·폐기합니다. 제목·조건 등 모든 항목을 입력해야 저장할 수 있고, 자유 입력 난이도는 1~4, 제안 코인은 0/100C, 인증 방식은 사용 안 함입니다. 일반 퀘스트의 제출·승인·정산과 사진 업로드는 이번 범위에 포함하지 않습니다.
